function AddRowToExtratoTable(data) {
    ...
    if (tipo == 'Venda' || tipo == 'Rendimento') {
        ...
        row_3.innerHTML = `-${valor}`;
        row_5.innerHTML = `<button data-toggle="tooltip" title="" class="pd-setting-ed buy-button" data-original-title="Vender"><i style="color: #FF0000;" class="fa fa-level-down" aria-hidden="true"></i></button>`;
    }
